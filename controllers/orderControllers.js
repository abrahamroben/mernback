...
module.exports.verifyRazorpayPayment = async(req, res) => {
    ...
    let verifiedPayment = validatePaymentVerification({ order_id: order_id, payment_id: req.body.razorpay_payment_id },
    ...
    if (verifiedPayment.isValid) {
        ...
        await Order.updateOne({ _id: req.body.error.metadata.order_id }, {
            $set: {
                status: 'Failed'
            }
        });
